module.exports = (function(){
  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_line() {
        ...
        var savedPos4 = pos;
        var result39 = parse_endline();
        var result33 = result39 !== null ? result39 : '';
        if (result33 !== null) {
          var result38 = parse_space();
          var result34 = result38 !== null ? result38 : '';
          if (result34 !== null) {
            var result35 = parse_tag_inline();
            if (result35 !== null) {
              var result37 = parse_anything();
        ...
        if (result31 !== null) {
          ...
          var savedPos3 = pos;
          var result30 = parse_endline();
          var result24 = result30 !== null ? result30 : '';
          if (result24 !== null) {
            var result29 = parse_space();
            var result25 = result29 !== null ? result29 : '';
            if (result25 !== null) {
              var result26 = parse_tag();
              if (result26 !== null) {
                var result28 = parse_anything();
          ...
          if (result22 !== null) {
            ...
            var result13 = result14 !== null
              ...
              res = check_tag_stack(tag.name) + "" + check_contents(end) + sp + "{%- " + tag.name + contents + " -%}";
      ...
      function parse_jinja_tag_original() {
        ...
        if (result2 !== null) {
          ...
          if (result3 !== null) {
            var result6 = parse_jinja_tag_contents_original();
      ...
      function parse_jinja_tag_inline_eol() {
        ...
        var result6 = parse_jinja_tag_original();
        if (result6 !== null) {
          var result0 = result6;
        } else {
          var savedPos0 = pos;
          var result3 = parse_jinja_tag();
          if (result3 !== null) {
            var result5 = parse_jinja_tag_contents();
            var result4 = result5 !== null ? result5 : '';
            if (result4 !== null) {
              var result2 = [result3, result4];
            } else {
      ...
      function parse_jinja_tag_inline() {
        ...
        if (result6 !== null) {
          ...
          var result3 = parse_jinja_tag();
          if (result3 !== null) {
            var result5 = parse_jinja_tag_contents_inline();
            var result4 = result5 !== null ? result5 : '';
            if (result4 !== null) {
              var result2 = [result3, result4];
            } else {
      ...
      function parse_mod_ident() {
        ...
        if (result5 !== null) {
          ...
          var result4 = parse_escaped();
          if (result4 !== null) {
            var result2 = result4;
          } else {
            var result3 = parse_jinja_variable();
            if (result3 !== null) {
              var result2 = result3;
            } else {
              var result2 = null;;
              ...
              if (result14 !== null) {
                ...
                if (result9 !== null) {
                  ...
                  if (result10 !== null) {
                    ...
                    if (result11 !== null) {
                      var result12 = parse_unquoted_contents();
                      if (result12 !== null) {
                        var result8 = [result9, result10, result11, result12];
                      } else {
                        var result8 = null;
      ...
      function parse_variable_contents() {
        ...
        var result2 = parse_variable_contents_rec();
        if (result2 !== null) {
          var result1 = [];
          while (result2 !== null) {
            result1.push(result2);
      ...
      function parse_variable_any_paren() {
        ...
        if (result14 !== null) {
          ...
          if (result10 !== null) {
            var result13 = parse_variable_any_paren();
            var result11 = result13 !== null ? result13 : '';
            if (result11 !== null) {
              if (input.substr(pos, 1) === ")") {
                var result12 = ")";
    ...
    var options, jinja_tags, current_indent, tag_stack, last_content, _ref;
  ...
  function stack_block(block, spaceless){
    ...
    return tag_stack.push({
      ...
      spaceless: spaceless != null ? spaceless : ""
    ...
    for (;;) {
      ...
      if (current_indent <= top_tag.indent) {
        ...
        if (top_tag.tag) {
          ...
          if (opt_jinja_tag == null || top.inside == null || (top.inside != null && !(opt_jinja_tag in top.inside)) || current_indent < top_tag.indent) {
